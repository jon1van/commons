...
import static io.github.jon1van.units.LatLong128.clampLongitude;
...
class LatLongFitter {
    ...
    KineticValues fitKineticsAtTimeZero() {
        ...
        Course course = Navigation.courseBtw(priorLocation, futureLocation);
    ...
    double deduceTurnRate() {
        ...
        Course priorToCurrent = Navigation.courseBtw(stepBack, current);
        Course currentToNext = Navigation.courseBtw(current, stepForward);
