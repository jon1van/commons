...
///
/// Use case: say you are given a time-series data set like "altitude vs time". You are then
...
public class GaussianWindow {
    ...
    ///
    /// NOTE: When this TimeWindow is used to filter data is will eliminate data beyond
    /// plus/minus
