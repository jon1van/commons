...
import static io.github.jon1van.utils.FileUtils.appendToFile;
...
///
/// SequentialFileWriter implements the ExceptionHandler interface so that it can be used as a
/// convenient way to organize warnings and error messages.
public class SequentialFileWriter implements ExceptionHandler {
    ...
    /// Create a SequentialFileWriter that writes files to System.getProperty("user.dir").
    public SequentialFileWriter() {
        this(System.getProperty("user.dir"));
    }

    /// Create a SequentialFileWriter that writes files to the specified directory.
    ///
