...
import static io.github.jon1van.units.Navigation.mod;
...
class LatLongFitterTest {
    ...
    void crossesDateLine() {
        ...
        assertThat(LatLongFitter.crossesDateLine(crossesDateLine)).isTrue();
        assertThat(LatLongFitter.crossesDateLine(crossesPrimeMeridian)).isFalse();
    }
    ...
    void moddedLongs() {
        ...
        assertThat(patchedData).containsExactly(179.8, 179.9, 180.0, 180.1, 180.2);
        ...
        assertThat(brokenData).containsExactly(359.8, 359.9, 0.0, 0.1, 0.2); // jumps from 359.9 to 0.1
    }
    ...
    void unModdingWorks_2() {
        ...
        while (longitude <= 180.0) {
            ...
            assertThat(longitude).isCloseTo(fixed, within(0.00001));
    ...
    void cannotUnMod_negative180() {
        ...
        assertThat(fixed).isEqualTo(180.0);
        assertThat(fixed).isNotEqualTo(longitude);
        ...
        assertThat(a.distanceTo(b).inNauticalMiles()).isEqualTo(0.0);
    }
}
