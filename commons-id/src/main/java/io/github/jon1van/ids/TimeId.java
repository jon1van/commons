...
///
/// For example, if you create 100 Million TimeId's that all embed the same timestamp (to the
...
///
/// TimeId's 86-bit allocation for pseudo-random bits permits 2^86 =
/// 77,371,252,455,336,267,181,195,264 possible unique hashes.
///
/// Besides uniqueness, TimeId provides 2 additional features. They are Comparable and they
...
///
/// Class design goals: Be unique, Be comparable by seed time, Enable compact serialization,
...
public class TimeId implements Comparable<TimeId>, HasTime {
    ...
    ///
    /// @param leftBits  The most significant bits of the `TimeId`
    /// @param rightBits The least significant bits of the `TimeId`
    ...
    /// @return The `bytes()` of this ID encoded as unpadded Base64 String (e.g.
    ...
    /// @return A hash code value for this `TimeId`
    public int hashCode() {
