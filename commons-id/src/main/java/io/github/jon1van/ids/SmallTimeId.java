...
///
/// Besides uniqueness, SmallTimeId provides 2 additional features. They are Comparable and they
...
///
/// Class design goals: Be unique, Be comparable by seed time, Enable VERY compact serialization,
...
///
/// SmallTimeId is different from Snowflake_ID because a TimeId does not know/care how the
/// "non-time
...
///
/// SmallTimeId's sole constructor requires the caller to provide the "21 non-time bits". This
/// means
...
///
/// Directly using SmallTimeId's constructor is discouraged because: (1) convenient factory
/// methods
...
///
/// Factory methods are provided for common use cases like hash-based ID construction and simple
