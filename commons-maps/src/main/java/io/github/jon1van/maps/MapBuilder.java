...
/// easier to do.
///
/// A MapBuilder provides a fluent API to create 1 of 3 output types: a MapImage, a
/// BufferedImage, or a File (png or jpg only).
///
/// A raw MapImage does not contain "MapFeatures". A MapImage is merely an aggregation of Map
...
///
/// Note: Generating a MapImage is best when you intend to repeatedly draw multiple related
/// images (e.g., when rendering a movie with an unchanging map background).
///
/// The MapBuilder "chain" supports turning on or off a local disk cache of map tile images.
