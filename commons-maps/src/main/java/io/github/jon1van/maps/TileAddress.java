...
import io.github.jon1van.units.HasLatLong;
...
public class TileAddress {
    ...
    public static TileAddress of(HasLatLong loc, int zoom) {
        int scale = 1 << zoom;
    ...
    /// @return a `Comparator<TileAddress>` That makes can sort TileAddress and easily identify
