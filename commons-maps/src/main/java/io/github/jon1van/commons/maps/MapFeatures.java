...
public class MapFeatures {
    ...
    private static class Circle implements MapFeature {
        ...
        public void drawOn(Graphics2D g, PixelLatLong zeroPixel) {
            ...
            PixelLatLong center = new PixelLatLong(loc.latLong(), zeroPixel.zoom(), zeroPixel.tileSize());
    ...
    /// @param c The color
    /// @param font The font
    /// @param ySpacing The vertical spacing between the lines of text (will frequently be font height + desired
    ///  spacing)
    ///
