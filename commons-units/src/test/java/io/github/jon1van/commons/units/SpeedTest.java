...
import static io.github.jon1van.commons.units.Distance.Unit.METERS;
import static io.github.jon1van.commons.units.Distance.Unit.MILES;
import static io.github.jon1van.commons.units.Speed.Unit.*;
import static io.github.jon1van.commons.units.Speed.unitFromString;
...
public class SpeedTest {
    ...
    public void testTimeToTravel() {
        ...
        assertThat(Speed.of(2.0, KNOTS).timeToTravel(Distance.ofNauticalMiles(1))).isEqualTo(Duration.ofMinutes(30));
    }
