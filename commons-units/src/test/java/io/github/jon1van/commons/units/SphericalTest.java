...
import static io.github.jon1van.commons.units.Spherical.*;
import static io.github.jon1van.commons.units.Spherical.angleDifference;
...
public class SphericalTest {
    ...
    public void testFeetPerNM() {
        ...
        assertThat(Spherical.feetPerNM()).isCloseTo(FEET_PER_NM, within(0.05));
    }
    ...
    public void testDistanceInNM_4args() {
        ...
        assertThat(Spherical.distanceInNM(0.0, 0.0, 10.0, 10.0)).isCloseTo(expected, within(0.75));
    }
    ...
    public void courseBtw_hasLatLong() {
        ...
        HasLatLong a = HasLatLong.from(0.0, 0.0);  // start at 0.0, 0.0
        HasLatLong b = HasLatLong.from(1.0, 1.0);  // move toward 1.0, 1.0
    ...
    public void testProjectionInDegrees_4args() {
        ...
        LatLong128 actual = Spherical.projectOut(0.0, 0.0, headingInDegrees, distNM);
    ...
    public void testGreatCircleOrigin() {
        ...
        LatLong128 actual = Spherical.greatCircleOrigin(latitude, longitude, course);
    ...
    public void testDistanceInNM_LatLongPair_LatLongPair() {
        ...
        assertThat(Spherical.distanceInNM(a, b)).isEqualTo(expected, within(0.75));
    }
...
//    }
    ...
    void testArcLengthSmallRadius() {
        ...
        assertThat(Spherical.arcLength(radius, angle)).isEqualTo(Math.PI / 2.0, within(0.01));
    }
    ...
    void testArcLengthLargeRadius() {
        ...
        assertThat(oneQuarterCircumferenceOfEarthInNM()).isEqualTo(Spherical.arcLength(radius, angle), within(0.01));
    }
}
