...
import static io.github.jon1van.units.Time.*;
...
public class TimeTest {
    ...
    public void testAverageTime() {
        ...
        assertThat(avg12).isEqualTo(expected);
        assertThat(avg21).isEqualTo(expected);
    }
    ...
    public void testConfirmApproximateTimeOrdering_farInPastFails() {
        ...
        assertThrows(
                IllegalArgumentException.class, () -> confirmApproximateTimeOrdering(currentTime, futureTime, maxLag));
    }
    ...
    void enclosingTimeWindow_finds_min_and_max() {
        ...
        assertThat(span.start()).isEqualTo(EPOCH.plusSeconds(-22));
        assertThat(span.end()).isEqualTo(EPOCH.plusSeconds(7));
    }
    ...
    public void testMax_twoDurations() {
        ...
        assertThat(max(longDur, smallDur)).isEqualTo(longDur);
    }
    ...
    public void testMin_twoDurations() {
        ...
        assertThat(min(longDur, smallDur)).isEqualTo(smallDur);
    }
    ...
    public void theDurationBetween_varags() {
        ...
        assertThat(theDurationBtw(time0, time4).isGreaterThanOrEqualTo(Duration.ofSeconds(4)))
                .isTrue();
        assertThat(theDurationBtw(time0, time4).isLessThanOrEqualTo(Duration.ofSeconds(4)))
                .isTrue();
        assertThat(theDurationBtw(time4, time0).isGreaterThanOrEqualTo(Duration.ofSeconds(4)))
                .isTrue();
        assertThat(theDurationBtw(time4, time0).isLessThanOrEqualTo(Duration.ofSeconds(4)))
                .isTrue();

        // adding a middle time does nothing
        assertThat(theDurationBtw(time0, time2, time4).isGreaterThanOrEqualTo(Duration.ofSeconds(4)))
                .isTrue();
        assertThat(theDurationBtw(time2, time0, time4).isLessThanOrEqualTo(Duration.ofSeconds(4)))
                .isTrue();
        assertThat(theDurationBtw(time4, time0, time2).isGreaterThanOrEqualTo(Duration.ofSeconds(4)))
                .isTrue();
        assertThat(theDurationBtw(time4, time2, time0).isLessThanOrEqualTo(Duration.ofSeconds(4)))
                .isTrue();
    }
    ...
    public void latest_hasTime_hasTime() {
        ...
        assertThat(latest(a, b)).isEqualTo(b);
        assertThat(latest(b, a)).isEqualTo(b);
    }
    ...
    public void toMap_collectionOfHasTimes() {
        ...
        assertThat(map.get(EPOCH)).isEqualTo(a);
        assertThat(map.get(EPOCH.plusMillis(10))).isEqualTo(b);
        assertThat(map.get(EPOCH.plusMillis(20))).isEqualTo(c);
    }
