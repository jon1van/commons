...
import static io.github.jon1van.units.Distance.*;
import static io.github.jon1van.units.Distance.Unit.*;
import static io.github.jon1van.units.Speed.Unit.MILES_PER_HOUR;
...
public class DistanceTest {
    ...
    public void min_minOfEmptyArrayIsNull() {
        Distance[] empty = new Distance[] {};
        assertThat(min(empty)).isNull();
    }

    @Test
    public void min_minOfSingletonArrayIsFound() {
        Distance[] oneEntry = new Distance[] {Distance.ofFeet(100)};
        assertThat(min(oneEntry)).isEqualTo(Distance.ofFeet(100));
    }
    ...
    public void max_maxOfSingletonArrayIsFound() {
        Distance[] oneEntry = new Distance[] {Distance.ofFeet(100)};
        assertThat(max(oneEntry)).isEqualTo(Distance.ofFeet(100));
    }

    @Test
    public void max_maxOfLongArrayIsFound() {
        var array1 = new Distance[] {Distance.ofFeet(1000.0), Distance.ofMeters(1), Distance.ofNauticalMiles(1.0)};
        var array2 = new Distance[] {Distance.ofMeters(1), Distance.ofNauticalMiles(1.0), Distance.ofFeet(1000.0)};

        assertThat(max(array1)).isEqualTo(Distance.ofNauticalMiles(1));
        assertThat(max(array2)).isEqualTo(Distance.ofNauticalMiles(1));
    }
