...
public class Spherical {
    ...
    public static LatLong128 projectOut(Double latDeg, Double lonDeg, Double headingDegree, Double distNM) {
    ...
    public static LatLong128 projectOut(
        ...
        LatLong128 pair = Spherical.projectOut(latDeg, lonDeg, mod(headingDegree + 90.0, 360.0), radiusNM);
