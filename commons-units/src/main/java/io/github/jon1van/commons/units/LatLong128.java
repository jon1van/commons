...
/// these two classes.
public class LatLong128 implements HasLatLong, Comparable<LatLong128> {
    ...
    public LatLong128 greatCircleOrigin(Double course) {
    ...
    public static LatLong128 avgLatLong(LatLong128... locations) {
        ...
        double y = 0;
        double z = 0;
        for (LatLong128 location : locations) {
    ...
    private static class SphericalUnitVector {
        ...
        private SphericalUnitVector(LatLong128 location) {
