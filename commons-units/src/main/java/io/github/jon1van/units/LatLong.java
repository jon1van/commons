...
public class LatLong implements HasLatLong, Comparable<LatLong> {
    ...
    /// Convert this "lossy compressed" LatLong into a LatLong128.  A LatLong128 uses twice the number of bytes to
    /// encode locations with precision beyond 8 decimal points (which is generally far more accurate than most
