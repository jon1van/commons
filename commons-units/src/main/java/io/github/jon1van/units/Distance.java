...
public record Distance(double amount, Unit unit) implements Comparable<Distance> {
    ...
    public int hashCode() {
        int hash = 5;
        hash = 59 * hash + Long.hashCode(Double.doubleToLongBits(this.amount));
    ...
    public String toString() {
        ...
        if (unit == Unit.NAUTICAL_MILES || unit == KILOMETERS || unit == MILES) {
            return toString(5);
        } else {
            return toString(2);
        }
