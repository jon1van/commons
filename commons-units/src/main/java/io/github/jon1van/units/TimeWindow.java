...
public class TimeWindow {
    ...
    public Iterator<Instant> iterator(Duration timeStep) {
        ...
        return steppedIteration(timeStep).iterator();
    }

    /// @param timeStep The duration of time between consecutive Instants in the returned List.
    ///
    ...
    public ArrayList<Instant> steppedIteration(Duration timeStep) {
        ...
        while (this.contains(current)) {
            ...
            current = current.plusMillis(timeStep.toMillis());
        }
